...
5. Verificá en **Table Editor** que aparecieron las tablas `profiles`, `scores`, `live_matches`, `match_messages`, `friends`, `clans`, `lobbies`, `lobby_players`, `lobby_matches`, etc., y la vista `best_scores`.
