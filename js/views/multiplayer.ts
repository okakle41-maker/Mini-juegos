 ...
 *
 * Solo aloja el Lobby Grupal 1v1 (Simon/Arrow/Termita: crear, listar,
 * unirse como rival o espectador) y el chat/leaderboards globales.
 * Signal Triangulation y Centro de Control (coop de 4 jugadores) NO
 * tienen sección acá — crear y unirse a esos se hace exclusivamente
 * desde su card en la vista "Lobby Online" (ver views/onlineLobby.ts/
 * .logic.ts), para no duplicar el punto de entrada.
 */
